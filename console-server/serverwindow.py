...
class Ui_ServerWindow(object):
    def setupUi(self, ServerWindow):
        ...
        ServerWindow.setMinimumSize(QSize(800, 500))
        ServerWindow.setMaximumSize(QSize(800, 500))
        ...
        self.fConnectRadio.setGeometry(QRect(10, 380, 111, 41))
        ...
        self.fDisconnectRadio.setGeometry(QRect(130, 380, 111, 41))
